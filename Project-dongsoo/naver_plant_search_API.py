...
# 📁 파일 경로 설정
plants_default_path = "./resData/관엽식물사전.csv"
popular_plants_path = "./saveFiles/plant_top10/popular_plants_20250702_170157.csv"
...
# 이미지로 저장
save_path = "./saveFiles/plant_pie_chart.png"
